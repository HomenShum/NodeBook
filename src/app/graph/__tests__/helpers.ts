 ...
 */
// global, users, user, my hashtags, my favorites, __user_relation_types__, __global_relation_types__, my stream, __card_statuses__, global_hashtags + 4 default statuses
export const MIN_NUM_NODES = 14;
...
export const MIN_NUM_RELATIONS = 15;
/**
 ...
 */
export const MIN_NUM_CREATED_RELATIONS = 13;
