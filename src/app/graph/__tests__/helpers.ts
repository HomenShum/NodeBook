 ...
 */
export const MIN_NUM_NODES = 6; // global, users, user, my hashtags, my favorites, __user_relation_types__
 ...
 */
export const MIN_NUM_CREATED_NODES = 4;

export const MIN_NUM_RELATIONS = 5;
/**
 ...
 */
export const MIN_NUM_CREATED_RELATIONS = 4;
