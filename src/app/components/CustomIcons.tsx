...
export const CardsIcon = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_4991_774)">
      <path
        d="M2.52246 11.5H15.4775C16.2158 11.5 16.759 10.9444 16.75 10.2441L16.7412 10.1025L15.8594 2.58984C15.7725 1.8483 15.0976 1.25018 14.3359 1.25H3.66504C2.94985 1.25 2.31268 1.77354 2.16406 2.45215L2.14062 2.58984L1.25977 10.1025C1.17034 10.866 1.73538 11.4999 2.52246 11.5ZM2.52246 11C2.33238 10.9999 2.11238 10.9416 1.94629 10.7656C1.81887 10.6306 1.76225 10.4683 1.75195 10.3125L1.75586 10.1602L2.63672 2.65039V2.64941C2.66739 2.38049 2.81451 2.15832 2.98633 2.00977C3.15936 1.86026 3.39799 1.75004 3.66406 1.75H14.335C14.6023 1.75 14.8408 1.86202 15.0127 2.01074C15.1831 2.15821 15.3308 2.37926 15.3623 2.64746L16.2441 10.1602V10.1611C16.2668 10.3559 16.2248 10.5856 16.0537 10.7666C15.8866 10.9434 15.6655 10.9999 15.4775 11H2.52246ZM3.75 14.125H14.25C14.3163 14.125 14.3799 14.0986 14.4268 14.0518C14.4736 14.0049 14.5 13.9413 14.5 13.875C14.5 13.8087 14.4736 13.7451 14.4268 13.6982C14.3799 13.6514 14.3163 13.625 14.25 13.625H3.75C3.68373 13.625 3.6201 13.6514 3.57324 13.6982C3.52639 13.7451 3.5 13.8087 3.5 13.875C3.5 13.9413 3.52639 14.0049 3.57324 14.0518C3.60842 14.0869 3.65309 14.1105 3.70117 14.1201L3.75 14.125ZM5.625 16.75H12.375C12.4413 16.75 12.5049 16.7236 12.5518 16.6768C12.5986 16.6299 12.625 16.5663 12.625 16.5C12.625 16.4337 12.5986 16.3701 12.5518 16.3232C12.5049 16.2764 12.4413 16.25 12.375 16.25H5.625L5.57617 16.2549C5.52809 16.2645 5.48342 16.2881 5.44824 16.3232C5.40139 16.3701 5.375 16.4337 5.375 16.5C5.375 16.5663 5.40139 16.6299 5.44824 16.6768C5.4951 16.7236 5.55873 16.75 5.625 16.75Z"
        fill="currentColor"
        stroke="currentColor"
      />
    </g>
    <defs>
      <clipPath id="clip0_4991_774">
...
export const QuickCaptureIcon = ({ size = 14 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 14 14" fill="none">
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M2.916 2.333a.583.583 0 0 0-.583.583v1.167a.583.583 0 1 1-1.167 0V2.916a1.75 1.75 0 0 1 1.75-1.75h1.167a.583.583 0 1 1 0 1.167H2.916ZM12.25 9.334c.323 0 .584.261.584.583v1.167a1.75 1.75 0 0 1-1.75 1.75H9.917a.583.583 0 0 1 0-1.167h1.167a.583.583 0 0 0 .583-.583V9.917c0-.322.261-.583.584-.583ZM1.75 9.334c.322 0 .583.261.583.583v1.167a.583.583 0 0 0 .583.583h1.167a.583.583 0 0 1 0 1.167H2.916a1.75 1.75 0 0 1-1.75-1.75V9.917c0-.322.261-.583.583-.583ZM11.667 1.678a.654.654 0 0 0-.462.192L5.777 7.297 5.47 8.531l1.233-.309 5.428-5.427a.654.654 0 0 0-.463-1.117Zm-1.287-.633a1.82 1.82 0 1 1 2.575 2.575L7.413 9.162a.583.583 0 0 1-.27.153l-2.334.583a.583.583 0 0 1-.708-.707l.584-2.333a.583.583 0 0 1 .153-.271l5.542-5.542Z"
      clipRule="evenodd"
    />
  </svg>
);
