 ...
 * Used in the modified LexicalTypeaheadMenuPlugin to provide the LexicalMenu component for rendering the typeahead menu.
 * Source: https://github.com/facebook/lexical/blob/main/packages/lexical-react/src/shared/LexicalMenu.ts
 */
