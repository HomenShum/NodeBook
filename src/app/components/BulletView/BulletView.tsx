  ...
  return (
    <button
      style={{
        ...
        width: "1rem",
        fontSize: "0.75rem",
        color: treeViewStore.hoveredNode?.id === bullet.id ? "black" : "transparent",
        cursor: "pointer",
      }}
    ...
    return (
      <>
        <div
          ...
          onMouseEnter={() => treeViewStore.setHoveredNode(bullet)}
          onMouseLeave={() => treeViewStore.setHoveredNode(null)}
        >
          ...
          <span
            ...
            onClick={() => {
              ...
              treeViewStore.setCurrentViewRoot(bullet);
            }}
          >
            {"\u2022"}
          </span>
          {/* relation type */}
          <div style={{ gap: "5px", display: "flex", alignItems: "flex-start" }}>
            <div>
              <Editor
                node={bullet}
